...
class EmitterMold
{
	...
	public var startColorAlpha :Float;
	public var startColorRed :Float;
	public var startColorGreen :Float;
	public var startColorBlue :Float;

	public var startColorVarianceAlpha :Float;
	public var startColorVarianceRed :Float;
	public var startColorVarianceGreen :Float;
	public var startColorVarianceBlue :Float;

	public var finishColorAlpha :Float;
	public var finishColorRed :Float;
	public var finishColorGreen :Float;
	public var finishColorBlue :Float;
	
	public var finishColorVarianceAlpha :Float;
	public var finishColorVarianceRed :Float;
	public var finishColorVarianceGreen :Float;
	public var finishColorVarianceBlue :Float;
	...
	public function new (pack :AssetPack, name :String)
	{
		...
		for (element in xml.firstElement().elements()) {
			...
			case "finishcolor":
				finishColorAlpha = getFloat(element, "alpha");
				finishColorRed = getFloat(element, "red");
				finishColorGreen = getFloat(element, "green");
				finishColorBlue = getFloat(element, "blue");
			case "finishcolorvariance":
				finishColorVarianceAlpha = getFloat(element, "alpha");
				finishColorVarianceRed = getFloat(element, "red");
				finishColorVarianceGreen = getFloat(element, "green");
				finishColorVarianceBlue = getFloat(element, "blue");
			...
			case "startcolor":
				startColorAlpha = getFloat(element, "alpha");
				startColorRed = getFloat(element, "red");
				startColorGreen = getFloat(element, "green");
				startColorBlue = getFloat(element, "blue");
			case "startcolorvariance":
				startColorVarianceAlpha = getFloat(element, "alpha");
				startColorVarianceRed = getFloat(element, "red");
				startColorVarianceGreen = getFloat(element, "green");
				startColorVarianceBlue = getFloat(element, "blue");
		...
		switch ([blendFuncSource, blendFuncDestination]) {
			case [1,1]:blendMode = Add;
			case [775,1]:blendMode = Fancy;
			case [1,771]:blendMode = null; // Normal
			case _:
				Log.warn("Unsupported particle blend functions", ["emitter", name, "source", blendFuncSource, "dest", blendFuncDestination ]);
				trace("emitter", name, "source", blendFuncSource, "dest", blendFuncDestination);
