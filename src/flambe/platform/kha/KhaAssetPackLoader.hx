...
import flambe.platform.kha.KhaSound;
import flambe.platform.kha.KhaTexture;
import flambe.platform.kha.KhaTextureRoot;
...
class KhaAssetPackLoader extends BasicAssetPackLoader
{
	...
	private var _logger :flambe.util.Logger;
}
