...
import flambe.platform.kha.KhaPipeline;
...
class KhaGraphics implements InternalGraphics
{
	...
	@:allow(flambe.platform.kha.KhaPlatform) private var _scaleOffset :Float = 1;
	@:allow(flambe.platform.kha.KhaPlatform) private var _heightOffset :Float = 0;
