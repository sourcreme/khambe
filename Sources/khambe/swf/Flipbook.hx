...
import khambe.display.ImageSprite;
...
class FlipbookFrame
{
	...
	@:allow(khambe) function new (texture :Texture, duration :Float)
	{
		this.texture = texture;
		this.duration = duration;
	}

	@:allow(khambe) function toSymbol () :Symbol
	{
		return new FrameSymbol(this);
	}
}

private class FrameSymbol implements Symbol
{
