...
interface Graphics
{
	...
	function drawTexture (texture :Texture, destX :Float, destY :Float, ?color :Int) :Void;

	function drawText (font :Font, text :String, color :Int, size :Int, destX :Float, destY :Float) :Void;

	/** Draws a texture sub-region at the given point. */
	function drawSubTexture (texture :Texture, destX :Float, destY :Float,
		sourceX :Float, sourceY :Float, sourceW :Float, sourceH :Float, ?color :Int) :Void;
