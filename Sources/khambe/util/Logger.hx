...
/**
 * A logging system, for printing formatted khambe_debug messages. Logging is stripped from release builds,
 * unless the `-D khambe_keep_logs` compiler flag is used.
 *
 * ```haxe
...
#if (khambe_debug || khambe_keep_logs)
	/**
