...
class System
{
     ...
     */
    public static var renderer (get, null) :RendererSystem<Dynamic>;
     ...
     */
    public static function init (title :String, width :Int, height :Int, cb : Void -> Void)
    {
        kha.System.init({samplesPerPixel: 4, title :title, width:width, height:height}, function() {
            if (!_calledInit) {
                _platform.init();
                _calledInit = true;
            }
